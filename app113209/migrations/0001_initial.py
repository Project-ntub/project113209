# Generated by Django 3.2 on 2024-10-07 09:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_id', models.ForeignKey(db_column='branch_id', on_delete=django.db.models.deletion.CASCADE, to='app113209.branch')),
                ('product_id', models.ForeignKey(db_column='product_id', on_delete=django.db.models.deletion.CASCADE, to='app113209.test_products')),
            ],
            options={
                'db_table': 'TEST_Sales',
            },
        ...
        migrations.CreateModel(
            name='TEST_Inventory',
            fields=[
                ('inventory_id', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ('stock_quantity', models.CharField(max_length=50)),
                ('last_updated', models.CharField(max_length=30)),
                ('branch_id', models.ForeignKey(db_column='branch_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app113209.test_stores')),
                ('product_id', models.ForeignKey(db_column='product_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app113209.test_products')),
            ],
            options={
