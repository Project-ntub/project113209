...
const routes = [
  ...
  { path: '/backend/role-management/create', name: '新增角色', component: RoleFormPage, meta: { requiresAuth: true },},
  { path: '/backend/role-management/edit/:id', name: '編輯角色', component: RoleFormPage, meta: { requiresAuth: true },},
